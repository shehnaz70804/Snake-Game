export default class Snake{
    ...
    move(){
        ...
        if(this.body[0].x<0 || this.body[0].y<0 || this.body[0].x>=this.scene.game.config.width || this.body[0].y>=this.scene.game.config.height){
            this.scene.scene.restart();
        }

        //Death by eating own tail - headpos === any tail position
